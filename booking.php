...
$hotelName = "The Ritz-Carlton"; // This should be dynamically fetched based on the selected hotel
?>
...
<head>
    ...
    <title>Booking - <?php echo $hotelName; ?></title>
...
<body>
    ...
    <div class="container mt-4">
        <h1>Book a Room at <?php echo $hotelName; ?></h1>
        <form action="submit_booking.php" method="POST">
            <div class="form-group">
                <label for="hotelName">Hotel Name:</label>
                <input type="text" class="form-control" id="hotelName" name="hotelName" value="<?php echo $hotelName; ?>" readonly>
            </div>
            <div class="form-group">
